...
Router.route('/bulbs/:_id', {
    name: 'bulbPage',
    waitOn: function() {
        return Session.get('sparkId') ? [ Meteor.subscribe('sparks', this.params._id), Meteor.subscribe('comments', Session.get('sparkId'))] : Meteor.subscribe('sparks', this.params._id);
    },
